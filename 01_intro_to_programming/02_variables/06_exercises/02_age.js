...
On line 15 the log method of the console object is invoked and an interpolated string is passed in as an argument. The string is interpolated because it is seen to use string literals inside backticks `` with the inclusion of ${} template literal symbols whereby the 
expression value is inserted / interpolated into the resulting string printed to the console / terminal window. 
...
On lines 16, 17, 18 and 19 these principles are repeated with adjustments to the variables used in the expressions to print differing results:
